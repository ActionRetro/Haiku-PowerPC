...
#define CB(IDNAME, NAME, HOTSPOT) {fCursor##NAME, B_CURSOR_ID_##IDNAME, \
		...
		CB(I_BEAM_HORIZONTAL, IBeamHorizontal, BPoint(11, 12)),
		C(MOVE,				Move,			kResizeHotspot),
		C(NOT_ALLOWED,		NotAllowed,		BPoint(8, 8)),
		CB(PROGRESS,		Progress,		BPoint(4, 3)),
		CB(RESIZE_EAST,		ResizeEast,		BPoint(10, 12)),
		CB(RESIZE_EAST_WEST, ResizeEastWest, BPoint(10, 12)),
		CB(RESIZE_NORTH,	ResizeNorth,	BPoint(12, 10)),
		CB(RESIZE_NORTH_EAST, ResizeNorthEast, BPoint(12, 12)),
		CB(RESIZE_NORTH_EAST_SOUTH_WEST, ResizeNorthEastSouthWest, BPoint(12, 12)),
		CB(RESIZE_NORTH_SOUTH, ResizeNorthSouth, BPoint(12, 10)),
		CB(RESIZE_NORTH_WEST, ResizeNorthWest, BPoint(12, 12)),
		CB(RESIZE_NORTH_WEST_SOUTH_EAST, ResizeNorthWestSouthEast, BPoint(12, 12)),
		CB(RESIZE_SOUTH,	ResizeSouth,	BPoint(12, 10)),
		CB(RESIZE_SOUTH_EAST, ResizeSouthEast, BPoint(12, 12)),
		CB(RESIZE_SOUTH_WEST, ResizeSouthWest, BPoint(12, 12)),
		CB(RESIZE_WEST,		ResizeWest,		BPoint(10, 12)),
